    ...
    <div className="max-w-4xl mx-auto px-6 py-16 md:py-28">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="md:col-span-2">
          <p className="text-xs uppercase tracking-[0.15em] text-zinc-500 font-medium mb-6">
            Items
          </p>
              ...
              >
                <div className="relative w-14 h-14 bg-[#111] rounded-sm overflow-hidden shrink-0">
                  {item.product_image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center text-zinc-600 text-[10px] tracking-widest">
                      IR
                    </div>
                  )}
                </div>
