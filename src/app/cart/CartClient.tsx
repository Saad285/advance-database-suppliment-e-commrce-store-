      ...
      <div className="lg:col-span-2">
        ...
        <div className="space-y-0 divide-y divide-border">
          {items.map((item) => (
            <div
              key={item.product_id}
              className="py-6 flex flex-col sm:grid sm:grid-cols-[2fr_1fr_1fr_auto] sm:items-center gap-4"
            >
              <div className="flex items-center gap-4">
                <div className="relative w-16 h-16 bg-card border border-border overflow-hidden shrink-0 rounded-sm">
                  {item.product_image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center text-muted-foreground/50 text-xs font-light tracking-widest bg-card">
                      IR
                    </div>
                  )}
                </div>
                <div>
                  <h4 className="text-sm text-foreground font-normal">
                    {item.product_name}
                  </h4>
